...
export default class GoogleMap extends Component {
  ...
  // Geolocation error callback fn. Query permissions to check if the error occured due to userAccount not allowing location to be shared
  posError() {
